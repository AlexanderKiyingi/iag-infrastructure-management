...
import (
	...
	"iag-infrastructure-management/backend/internal/handlers"
	"iag-infrastructure-management/backend/internal/middleware"
	"iag-infrastructure-management/backend/internal/migrate"
)
...
func main() {
	...
	go func() {
		log.Printf("infrastructure-management listening on :%s (aud=%s)", cfg.Port, cfg.Audience)
