// Command migrate applies the infrastructure management schema migrations out of band.
//
...
// with AUTO_MIGRATE=true: the same versions, the same infrastructure.schema_migrations
